...
func cloneState(st InstanceState) InstanceState {
	...
	// Copy PendingCommands: each envelope carries Input/Payload maps and an
	...
	//
	// ONE LEVEL, exactly like Variables and every other map on this struct: see
	// PendingCommand.clone. A nested value inside an Input map stays shared.
