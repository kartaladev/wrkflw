...
func TestServiceTaskAndBusinessRuleTaskEmitInvokeAction(t *testing.T) {
	...
	cases := []testCase{
		{
			name: "service task default-by-id: Name equals node id",
			def: &model.ProcessDefinition{
		...
		{
			name: "service task explicit name: Name is explicit",
			def: &model.ProcessDefinition{
		...
		{
			name: "business rule task explicit name: Name is explicit",
			def: &model.ProcessDefinition{
		...
		{
			name: "business rule task default-by-id: Name equals node id",
			def: &model.ProcessDefinition{
