...
// reference call-link store without reaching its unexported internals, keeping
// seeding off the shipped production API.
...
// same calls production makes when a child instance completes), keeping seeding
