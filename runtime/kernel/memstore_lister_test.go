...
func TestMemStoreListTwoPageWalk(t *testing.T) {
	...
	p1, err := ms.List(t.Context(), kernel.InstanceFilter{Status: &running, Limit: 2})
	if err != nil {
	...
	p2, err := ms.List(t.Context(), kernel.InstanceFilter{Status: &running, Limit: 2, Cursor: p1.NextCursor})
	if err != nil {
