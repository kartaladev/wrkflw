...
// goroutine via [Scheduler.Close], the advisory-lock ownership connection, the
...
// resource holders that expose Close() error — [Scheduler.Close], the
// advisory-lock io.Closer, the casbin closer — into the group.
