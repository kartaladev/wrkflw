...
// NeutralLock mirrors the public scheduler.Lock shape (ctx-in/error-out, no
// vendor type). AdaptLocker wraps a value producing these into a gocron.Locker so
// the public scheduler façade can hand its neutral Locker down without importing
// gocron.
type NeutralLock interface {
	Unlock(ctx context.Context) error
}

// NeutralLocker mirrors the public scheduler.Locker shape. Its method set is
...
// NeutralElector mirrors the public scheduler.Elector shape. Its single method
...
// it). This is how the public scheduler façade plumbs its neutral Locker down to
