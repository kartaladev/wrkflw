...
// gocron or a DB driver into the public scheduler signatures. Obtain a
// database-backed implementation from scheduler/backend/{postgres,mysql} and
...
// constructor (scheduler/backend/{postgres,mysql}.NewElector) and its lifecycle
